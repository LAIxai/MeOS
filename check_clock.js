...
console.log('\u3256 残り時間の段');
{
 ...
 ok(M(730*86400*S)==='2y 0d', '\u2605\u26052年後= 2y 0d(1年を越えたら時分秒は落とす)', M(730*86400*S));
 ok(M((365+12)*86400*S)==='1y 12d', '  1年12日', M((365+12)*86400*S));
 ok(!/:/.test(M(730*86400*S)), '\u2605年の段には「:」thatが出ない(時分の区切りso)', M(730*86400*S));
}
