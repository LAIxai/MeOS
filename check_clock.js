...
console.log('\u247b copy \u23f0 は ⏰行だけを写す');
{
  ...
  ok(/closest\('#clk-lock,#clk-unlock,#clk-anchor,#clk-pbtn,#clk-pring,#clk-rep,#clk-dir,#clk-cyc,#clk-tagin,#clk-copy,#clk-read,#clk-now,#clk-set'\)/.test(S9),
...
console.log('\u3261 \u23f8\u306f\u3044\u3064\u3082\u8d64 / \u4e00\u89a7\u306e\u5199\u3057\u3092\u65b0\u3057\u304f\u3059\u308b / \u2610\u3092\u62bc\u3057\u3066\u3082\u52b9\u304f');
{
 ...
 ok(/var _hit=\(ev\.target&&ev\.target\.closest\)\?ev\.target\.closest\('#clk-lock,#clk-unlock,#clk-anchor,#clk-pbtn,#clk-pring,#clk-rep,#clk-dir,#clk-cyc,#clk-tagin,#clk-copy,#clk-read,#clk-now,#clk-set'\)/.test(S),
